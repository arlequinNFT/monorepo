...
const Intro = () => {
  return (
    <div className="flex justify-center items-center">
      <section className="absolute max-w-5xl 3xl:max-w-7xl z-10">
        <div className="relative py-20 3xl:py-32 backdrop-blur-lg bg-white/10 rounded-3xl lg:rounded-[5rem] shadow-xl">
      ...
      <div className="relative h-[25vh] lg:h-[65vh] 3xl:h-[55vh] w-full">
        <img
